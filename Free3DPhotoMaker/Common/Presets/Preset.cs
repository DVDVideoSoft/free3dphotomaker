...
namespace DVDVideoSoft.Presets
{
    ...
    public class Preset : System.Collections.ObjectModel.Collection<string>, IList<string>
    {
        ...
        private static int defaultVideoCodec = 0;
        ...
        public Preset(string name, string description, string extension,
                        ...
                        int container, int videoCodec, string category = null, string additionalParams = "")
            : this()
        {
            this.Name = name;
        ...
        public static bool operator ==(Preset a, Preset b)
        {
            ...
            return b.Name == a.Name && b.Description == a.Description && b.Extension == a.Extension &&
                    ...
                    b.AudioChannels == a.AudioChannels && b.VideoFormat == a.VideoFormat && b.Container == a.Container && 
                    b.VideoCodec == a.VideoCodec && b.VideoWidth == a.VideoWidth && b.VideoWidth == a.VideoWidth && 
                    b.VideoHeight == a.VideoHeight && b.VideoFrameRate == a.VideoFrameRate && b.VideoBitrate == a.VideoBitrate && 
                    b.AdditionalParams == a.AdditionalParams && b.Category == a.Category;
        }
        ...
        {
            return (int)((this.AudioBitrate * this.AudioSampleRate * this.AudioChannels * this.VideoFormat * this.Container * this.VideoCodec * this.VideoWidth * this.VideoHeight) + this.VideoFrameRate);
        }
