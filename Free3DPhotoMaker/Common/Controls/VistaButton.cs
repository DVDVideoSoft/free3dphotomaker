...
{
    /// <summary>
    /// Button control by Thomas R. Wolfe (http://www.codeproject.com/KB/buttons/VistaButton.aspx).
    /// </summary>
    [DefaultEvent("Click")]
    public class VistaButton : System.Windows.Forms.UserControl
    {
        ...
        /// <summary>
        /// The image displayed on the button that  is used to help the user identify it's function if the text is ambiguous.
        /// </summary>
        [Category("Image"),
         DefaultValue(null),
        ...
        /// <summary>
        /// The radius for the button corners. The greater this value is, the more 'smooth' the corners are. This property should not be greater than half of the controls height.
        /// </summary>
        [Category("Appearance"),
         DefaultValue(8),
        ...
        /// <summary>
        /// The bottom color of the button that will be drawn over the base color.
        /// </summary>
        [Category("Appearance"),
        ...
        /// <summary>
        /// The backing color that the rest of  the button is drawn. For a glassier effect set this property to Transparent.
        /// </summary>
        [Category("Appearance"),
         DefaultValue(typeof(Color), "Black"),
        ...
        /// <summary>
        /// Draws the outer border for the control using the ButtonColor property.
        /// </summary>
        ...
        /// <summary>
        /// Draws the inner border for the control using the HighlightColor property.
        /// </summary>
        /// <param name="g">The graphics object used in the paint event.</param>
        ...
        /// <summary>
        /// Draws the Highlight over the top of the control using the HightlightColor.
        /// </summary>
        /// <param name="g">The graphics object used in the paint event.</param>
        ...
        /// <summary>
        /// Draws the glow for the button when the mouse is inside the client area using the GlowColor property.
        /// </summary>
        /// <param name="g">The graphics object used in the paint event.</param>
        ...
        private void DrawText(Graphics g)
        {
            ...
            Rectangle r = new Rectangle(8, 8, this.Width - 17, this.Height - 15);
